const formSuperAdmin = document.getElementById("formSuperAdmin"); /* Se obtiene el elemento del formulario utilizando su ID. */
const nombre = document.getElementById("nombre"); /* Se obtienen los elementos del formulario de registro de superadministrador utilizando sus IDs. */
const apellido = document.getElementById("apellido"); /* Se obtienen los elementos del formulario de registro de superadministrador utilizando sus IDs. */
const email = document.getElementById("email"); /* Se obtienen los elementos del formulario de registro de superadministrador utilizando sus IDs. */
const telefono = document.getElementById("telefono"); /* Se obtienen los elementos del formulario de registro de superadministrador utilizando sus IDs. */
const password = document.getElementById("password"); /* Se obtienen los elementos del formulario de registro de superadministrador utilizando sus IDs. */
...
const submitButton = formSuperAdmin.querySelector("button[type='submit']"); /* Se obtiene el botón de envío del formulario. */
...
formSuperAdmin.addEventListener("submit", (e) => { /* Se agrega un evento de escucha al formulario para detectar cuando se envía. */
    ...
    fetch(
        `${API_URL}/api/superadmin/register`,
        {
            method: "POST",
            headers: {
        ...
        .catch((error) => {
            ...
            console.error(
                "Error registrando superadministrador:",
                error
            );
